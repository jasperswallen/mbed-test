...
#define CLOCK_SOURCE                                                      USE_PLL_HSE_EXTC                                        // set by application[MicroDAQHub]
...
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                   ETHERNET                                                // set by target:MicroDAQHub
#define MBED_CONF_TARGET_STDIO_UART_RX                                    PB_7                                                    // set by application[MicroDAQHub]
#define MBED_CONF_TARGET_STDIO_UART_TX                                    PB_6                                                    // set by application[MicroDAQHub]
