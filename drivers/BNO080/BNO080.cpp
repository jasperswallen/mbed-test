...
BNO080Base::BNO080Base(PinName user_INTPin, PinName user_RSTPin) :
		_int(user_INTPin),
		_rst(user_RSTPin, 1),
...
BNO080I2C::BNO080I2C(PinName user_SDApin, PinName user_SCLpin, PinName user_INTPin, PinName user_RSTPin,
					   uint8_t i2cAddress, int i2cPortSpeed) :
	   BNO080Base(user_INTPin, user_RSTPin),
...
BNO080SPI::BNO080SPI(PinName rstPin, PinName intPin, PinName wakePin, PinName misoPin,
					 PinName mosiPin, PinName sclkPin, PinName csPin, int spiSpeed):
BNO080Base(intPin, rstPin),
