...
public:
	 ...
	 */
	BNO080Base(PinName user_INTPin, PinName user_RSTPin);
...
protected:
	 ...
	 */
	virtual bool receivePacket(std::chrono::milliseconds timeout=1ms) = 0;
...
public:
	 ...
	 */
	BNO080I2C(PinName user_SDApin, PinName user_SCLpin, PinName user_INTPin, PinName user_RSTPin, uint8_t i2cAddress=0x4a, int i2cPortSpeed=400000);
...
public:
	 ...
	 */
	BNO080SPI(PinName rstPin, PinName intPin, PinName wakePin, PinName misoPin, PinName mosiPin, PinName sclkPin, PinName csPin, int spiSpeed=3000000);
